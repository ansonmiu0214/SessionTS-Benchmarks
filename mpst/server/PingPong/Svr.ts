...
class Session {
    ...
    private initialState: Implementation.S14;
    ...
    constructor(wss: WebSocket.Server,
        ...
        this.activeRoles = new Set([Roles.Peers.Client]);

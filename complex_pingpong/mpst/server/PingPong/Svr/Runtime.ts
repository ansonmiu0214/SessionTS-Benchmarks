...
type StateInitialiser<SessionID> = (sessionID: SessionID) => State.S14;
...
class Session {
    ...
    constructor(id: string,
        ...
        this.activeRoles = new Set([Role.Peers.Client]);
